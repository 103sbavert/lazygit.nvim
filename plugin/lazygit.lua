...
cmd("LazyGit", function() require("lazygit").lazygit() end)

--- Open lazygit log view.
cmd("LazyGitLog", function() require("lazygit").lazygitlog() end)

--- Open lazygit for the current file's repository.
cmd(
    "LazyGitCurrentFile",
    function() require("lazygit").lazygitcurrentfile() end
)

--- Open lazygit filtered to current path.
cmd("LazyGitFilter", function() require("lazygit").lazygitfilter() end)

--- Open lazygit filtered to current file.
cmd(
    "LazyGitFilterCurrentFile",
    function() require("lazygit").lazygitfiltercurrentfile() end
)

--- Open lazygit config file for editing.
cmd("LazyGitConfig", function() require("lazygit").lazygitconfig() end)
